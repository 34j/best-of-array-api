...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 6.6K · 🔀 28K · 📥 300K · 📦 860K · 📋 62K - 29% open · ⏱️ 18.06.2026):

  ```
  git clone https://github.com/pytorch/pytorch
  ```

- [PyPi](https://pypi.org/project/torch) (📥 86M / month · 📦 42K · ⏱️ 17.06.2026):
`
	pip install torch
	`
</details>
<details><summary><b><a href="https://github.com/jax-ml/jax">JAX</a></b> (🥈46 ·  ⭐ 36K · 📈) - Composable transformations of Python+NumPy programs:.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code>Non-CPU</code></summary>

- [GitHub](https://github.com/jax-ml/jax) (👨‍💻 1.1K · 🔀 3.6K · 📦 50K · 📋 7.8K - 30% open · ⏱️ 18.06.2026):

  ```
  git clone https://github.com/jax-ml/jax
  ```

- [PyPi](https://pypi.org/project/jax) (📥 20M / month · 📦 4.6K · ⏱️ 17.06.2026):
`
	pip install jax
	`
</details>
...
- [GitHub](https://github.com/numpy/numpy) (👨‍💻 2.1K · 🔀 12K · 📥 1.2M · 📦 3.6M · 📋 14K - 16% open · ⏱️ 18.06.2026):

  ```
  git clone https://github.com/numpy/numpy
  ```

- [PyPi](https://pypi.org/project/numpy) (📦 190K · ⏱️ 02.06.2026):
`
	pip install numpy
	`
</details>
<details><summary><b><a href="https://github.com/dask/dask">Dask</a></b> (🥈46 ·  ⭐ 14K) - Parallel computing with task scheduling. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code>Non-CPU</code></summary>

- [GitHub](https://github.com/dask/dask) (👨‍💻 650 · 🔀 1.9K · 📦 80K · 📋 5.8K - 21% open · ⏱️ 18.06.2026):

  ```
  git clone https://github.com/dask/dask
  ```

- [PyPi](https://pypi.org/project/dask) (📥 25M / month · 📦 3.7K · ⏱️ 11.06.2026):
`
	pip install dask
	`
</details>
...
- [PyPi](https://pypi.org/project/ivy) (📥 23K / month · 📦 16 · ⏱️ 16.06.2025):
`
	pip install ivy
	`
</details>
...
- [GitHub](https://github.com/pydata/sparse) (👨‍💻 63 · 🔀 130 · 📦 2.3K · 📋 340 - 21% open · ⏱️ 18.06.2026):

  ```
  git clone https://github.com/pydata/sparse
  ```

- [PyPi](https://pypi.org/project/sparse) (📥 1.2M / month · 📦 310 · ⏱️ 19.02.2026):
`
	pip install sparse
	`
</details>
...
- [GitHub](https://github.com/Quantco/ndonnx) (👨‍💻 26 · 🔀 3 · 📦 30 · 📋 36 - 16% open · ⏱️ 16.06.2026):

  ```
  git clone https://github.com/Quantco/ndonnx
  ```

- [PyPi](https://pypi.org/project/ndonnx) (📥 4.3K / month · 📦 8 · ⏱️ 16.06.2026):
`
	pip install ndonnx
	`
</details>
...
- [GitHub](https://github.com/34j/numpy-flint-arb) (👨‍💻 3 · 📥 40 · 📋 2 - 50% open · ⏱️ 15.06.2026):

  ```
  git clone https://github.com/34j/numpy-flint-arb
  ```

- [PyPi](https://pypi.org/project/numpy-flint-arb) (📥 250 / month · ⏱️ 14.06.2026):
`
...
- [GitHub](https://github.com/data-apis/array-api-compat) (👨‍💻 28 · 🔀 44 · 📥 280 · 📦 800 · 📋 150 - 24% open · ⏱️ 15.06.2026):
...
- [GitHub](https://github.com/data-apis/array-api-extra) (👨‍💻 20 · 🔀 21 · 📦 34 · 📋 120 - 42% open · ⏱️ 18.06.2026):

  ```
  git clone https://github.com/data-apis/array-api-extra
  ```

- [PyPi](https://pypi.org/project/array-api-extra) (📥 25K / month · 📦 32 · ⏱️ 10.06.2026):
`
...
- [GitHub](https://github.com/data-apis/array-api-strict) (👨‍💻 33 · 🔀 13 · 📥 120 · 📋 53 - 20% open · ⏱️ 15.06.2026):

  ```
  git clone https://github.com/data-apis/array-api-strict
  ```

- [PyPi](https://pypi.org/project/array-api-strict) (📥 140K / month · 📦 32 · ⏱️ 23.02.2026):
`
...
- [GitHub](https://github.com/34j/types-array-api) (👨‍💻 3 · 🔀 1 · 📥 64 · 📋 5 - 40% open · ⏱️ 15.06.2026):
...
<details><summary><b><a href="https://github.com/pydata/xarray">xarray</a></b> (🥇33 ·  ⭐ 4.2K · 📉) - N-D labeled arrays and datasets in Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/pydata/xarray) (👨‍💻 610 · 🔀 1.3K · 📦 45K · 📋 5.3K - 25% open · ⏱️ 18.06.2026):
...
<details><summary><b><a href="https://github.com/scikit-hep/ragged">ragged</a></b> (🥈19 ·  ⭐ 48 · 📈) - Manipulating ragged arrays in an Array API compliant way. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/scikit-hep/ragged) (👨‍💻 5 · 🔀 9 · 📦 58 · 📋 37 - 21% open · ⏱️ 03.06.2026):

  ```
  git clone https://github.com/scikit-hep/ragged
  ```

- [PyPi](https://pypi.org/project/ragged) (📥 2K / month · 📦 4 · ⏱️ 03.06.2026):
`
	pip install ragged
	`
</details>
...
- [GitHub](https://github.com/34j/array-api-negative-index) (👨‍💻 3 · 📥 8 · ⏱️ 15.06.2026):
...
- [GitHub](https://github.com/helmholtz-analytics/heat) (👨‍💻 69 · 🔀 65 · 📥 95 · 📦 81 · 📋 890 - 9% open · ⏱️ 16.06.2026):
...
- [GitHub](https://github.com/wilsonrljr/sysidentpy) (👨‍💻 22 · 🔀 100 · 📦 28 · 📋 72 - 16% open · ⏱️ 13.06.2026):
