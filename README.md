...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 6.7K · 🔀 28K · 📥 300K · 📦 860K · 📋 62K - 29% open · ⏱️ 25.06.2026):

  ```
  git clone https://github.com/pytorch/pytorch
  ```

- [PyPi](https://pypi.org/project/torch) (📥 87M / month · 📦 42K · ⏱️ 17.06.2026):
`
	pip install torch
	`
</details>
...
- [GitHub](https://github.com/numpy/numpy) (👨‍💻 2.1K · 🔀 12K · 📥 1.2M · 📦 3.7M · 📋 14K - 16% open · ⏱️ 25.06.2026):
...
<details><summary><b><a href="https://github.com/jax-ml/jax">JAX</a></b> (🥈46 ·  ⭐ 36K) - Composable transformations of Python+NumPy programs: differentiate,.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code>Non-CPU</code></summary>

- [GitHub](https://github.com/jax-ml/jax) (👨‍💻 1.1K · 🔀 3.7K · 📦 50K · 📋 7.9K - 31% open · ⏱️ 25.06.2026):

  ```
  git clone https://github.com/jax-ml/jax
  ```

- [PyPi](https://pypi.org/project/jax) (📥 19M / month · 📦 4.6K · ⏱️ 17.06.2026):
`
	pip install jax
	`
</details>
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 650 · 🔀 1.9K · 📦 80K · 📋 5.8K - 21% open · ⏱️ 23.06.2026):
...
- [GitHub](https://github.com/pydata/sparse) (👨‍💻 64 · 🔀 130 · 📦 2.3K · 📋 340 - 21% open · ⏱️ 25.06.2026):
...
<details><summary><b><a href="https://github.com/34j/numpy-flint-arb">numpy-flint-arb</a></b> (🥉11 ·  ⭐ 1 · 🐣) - Arbitrary precision floating / ball arithmetic.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>Verified</code> <code>Multiprecision</code></summary>

- [GitHub](https://github.com/34j/numpy-flint-arb) (👨‍💻 3 · 📥 40 · 📋 2 - 50% open · ⏱️ 25.06.2026):

  ```
  git clone https://github.com/34j/numpy-flint-arb
  ```

- [PyPi](https://pypi.org/project/numpy-flint-arb) (⏱️ 14.06.2026):
`
...
- [GitHub](https://github.com/data-apis/array-api-compat) (👨‍💻 28 · 🔀 44 · 📥 280 · 📦 810 · 📋 150 - 24% open · ⏱️ 15.06.2026):
...
- [GitHub](https://github.com/data-apis/array-api-extra) (👨‍💻 20 · 🔀 21 · 📦 37 · 📋 120 - 42% open · ⏱️ 22.06.2026):

  ```
  git clone https://github.com/data-apis/array-api-extra
  ```

- [PyPi](https://pypi.org/project/array-api-extra) (📥 27K / month · 📦 32 · ⏱️ 10.06.2026):
`
...
- [PyPi](https://pypi.org/project/array-api-strict) (📥 150K / month · 📦 32 · ⏱️ 23.02.2026):
`
	pip install array-api-strict
	`
</details>
<details><summary><b><a href="https://github.com/data-apis/array-api-tests">array-api-tests</a></b> (🥉14 ·  ⭐ 73) - Test suite for Python array API standard compliance. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/34j/types-array-api">types-array-api</a></b> (🥇19 ·  ⭐ 7 · 📈) - Autogenerated types for array-api-compat and array API -.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/34j/types-array-api) (👨‍💻 3 · 🔀 1 · 📥 64 · 📋 5 - 40% open · ⏱️ 25.06.2026):

  ```
  git clone https://github.com/34j/types-array-api
  ```

- [PyPi](https://pypi.org/project/types-array-api) (📥 11K / month · 📦 18 · ⏱️ 28.02.2026):
`
...
- [GitHub](https://github.com/scikit-hep/ragged) (👨‍💻 5 · 🔀 9 · 📦 59 · 📋 37 - 21% open · ⏱️ 03.06.2026):

  ```
  git clone https://github.com/scikit-hep/ragged
  ```

- [PyPi](https://pypi.org/project/ragged) (📥 5.5K / month · 📦 4 · ⏱️ 03.06.2026):
`
	pip install ragged
	`
</details>
<details><summary><b><a href="https://github.com/mdhaber/marray">marray</a></b> (🥉18 ·  ⭐ 33 · 📈) - Masked versions of array API compatible arrays. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/marray) (📥 1.2K / month · ⏱️ 18.09.2025):
`
	pip install marray
	`
</details>
...
- [GitHub](https://github.com/34j/array-api-negative-index) (👨‍💻 3 · 📥 8 · ⏱️ 25.06.2026):
...
- [GitHub](https://github.com/quantity-dev/quantity-array) (👨‍💻 5 · 🔀 2 · 📋 19 - 68% open · ⏱️ 22.06.2026):
...
- [GitHub](https://github.com/helmholtz-analytics/heat) (👨‍💻 69 · 🔀 66 · 📥 95 · 📦 82 · 📋 890 - 9% open · ⏱️ 25.06.2026):

  ```
  git clone https://github.com/helmholtz-analytics/heat
  ```

- [PyPi](https://pypi.org/project/heat) (📥 1K / month · ⏱️ 26.03.2026):
`
	pip install heat
	`
</details>
